            ...
            <div class="modal-content">
                <form @submit.prevent="editmode ? updateUser() : createUser()">
                    <div class="modal-header">
                        ...
                        <h5 v-show="editmode" class="modal-title" id="addNewLabel">Edit User's Info</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <textarea v-model="form.bio" type="text" name="bio" placeholder="Short bio for user ( Optional )" class="form-control" 
